...
# 替换为你的合约地址(需要修改)
contract_address = '0xd5947b43435b394f45E88e5Ca0037DCE8d1be7e0'
...
# 假设合约中有一个名为 storeAesEncryptedData 的可写函数，需要传入一个参数
hex_string = ''
...
# 构建交易(storeAesEncryptedData 需要修改)
transaction = contract.functions.storeAesEncryptedData(hex_string).build_transaction({
